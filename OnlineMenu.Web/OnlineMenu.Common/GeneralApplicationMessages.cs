namespace OnlineMenu.Common
{
    public static class GeneralApplicationMessages
    {
        ...
        public const string LockedAccountDevMessage = "Your account has been locked out due to multiple failed login attempts, please try again after one minute.";
        public const string LockedAccountProdMessage = "Your account has been locked out due to multiple failed login attempts, please try again after five minutes.";
	}
}
